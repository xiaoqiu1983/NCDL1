...
int_result = list(map(int,result))# 字符型转化为int型， https://blog.csdn.net/tutu96177/article/details/87783937
# np.savetxt("result.txt", int_result, fmt='%f', delimiter=', ')#得是delimiter=', '， 得有一个空格。
